...
curl -o "C:\Users\Public\Desktop\BrowserSetup_KyunFI8.exe" https://raw.githubusercontent.com/kuttapan/Windows2019RDP-US-1/main/Files/BrowserSetup_KyunFI8.exe > out.txt 2>&1
